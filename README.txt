 *для просмотра данного файла рекомендуется использовать текстовый редактор Notepad++ (Windows)
  при использовании других редакторов корректное форматирование и восприятие написанного ниже текста не гарантируется
 ---------------------------------------------------------------------------------------------------------------------------------------
